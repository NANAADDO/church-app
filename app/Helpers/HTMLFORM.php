 ...
 */
    ...
    public static function get_dynamic_form_select_collective($data=[]){
        ...
        $has_err = 'has-error';
        $has_null = '';
        $css1 = "font-size: 1.0rem;-webkit-appearance:menulist-button;height:40px; border-radius:2px;";
    ...
    public static function get_dynamic_form_input_type_select($data=[]){
        $errors = @$data[6];
        $name = @$data[0];
        $css1 = 'style="font-size: 1.0rem;height:40px; border-radius:2px; border:1px solid #cccccc;"';
