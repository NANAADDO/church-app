...
@section('content')
    <div class="container-fluid">
        <?php
        $right =  Permissions::confirm_user_permission('/admin/collectiongroups');
        ?>
        <div class="product-sales-chart shadow" style="margin-bottom: 5px; min-height: 300px;">
            <div class="portlet-title">

                           @include('crud.top',['routename'=>'admin/collectiongroups','modulename'=>'Collection Groups'])
  @if ($data->count())
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($data as $item)
                                    <tr>
                                       ...
                                       <td class="td-actions">
                                 @include('crud.down',['route'=>'admin/collectiongroups','id'=>$item->id])
