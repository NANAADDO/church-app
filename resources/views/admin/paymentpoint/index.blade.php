...
<?php
        $right =  Permissions::confirm_user_permission('/admin/paymentpoint');
        ?>
        <div class="product-sales-chart shadow" style="margin-bottom: 5px; min-height: 300px;">
            <div class="portlet-title">

                           @include('crud.top',['routename'=>'admin/paymentpoint','modulename'=>'Payment.php'])
  @if ($data->count())
                            ...
                            <table class="table table-borderless">
                                ...
                                @foreach($data as $item)
                                    <tr>
                                       ...
                                       <td class="td-actions">
                                 @include('crud.down',['route'=>'admin/paymentpoint','id'=>$item->id])
