                    ...
                    <div class="panel-heading hbuilt mailbox-hd">
                        <div class="text-center p-xs font-normal">
                            ...
                            <div class="input-group">
                                <input type="text" class="form-control input-sm search_to_pay" placeholder="search by Receipt ID..." id="admin/rollbackpayment"> <span class="input-group-btn active-hook"> <button type="button" class="btn btn-sm btn-default">Search
											</button> </span></div>
                        </div>
                    </div>
