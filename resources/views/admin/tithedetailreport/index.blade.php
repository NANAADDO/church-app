    ...
    <div class="product-sales-chart shadow" style="margin-bottom: 5px; min-height: 300px;">
        <div class="portlet-title">
            ...
            <div class="row">
                ...
                {!! HtmlEntities::get_dynamic_form_complete_select_c3_collective(['month_paid', 'false','5' ,"form-control","",DBSELOPTION::get_all_month(),$errors,$read,'  By Month ?',null])!!}
                {!! HtmlEntities::get_dynamic_form_complete_select_c3_collective(['year_paid', 'false','5' ,"form-control","",DBSELOPTION::get_all_years(),$errors,$read,'  By Year ?',null])!!}
