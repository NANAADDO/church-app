...
@section('content')
                ...
                <div class="hpanel shadow-lg" >
                    ...
                    <div class="panel-heading hbuilt mailbox-hd">
                        ...
                        <div class="text-center p-xs font-normal">
                            ...
                            <h4 class="text-info " style="text-align: left;">Welfare Payment Collection</h4>
                            <hr/>
                            <div class="row">
                            <div class="col-md-4">
                                <div class=" col-md-12">

                                        {!! Form::select('',DBSELOPTION::get_all_collection_based_groups(2),null,array('class'=>'form-control','id'=>'welare_type','placeholder'=>'select welfare type')) !!}

                            </div>
                            </div>
                            <div class="col-md-8">
                            <div class="input-group">
                                <input type="text" class="form-control input-sm search_to_pay_multiple_select" placeholder="search by member ID/ name..." id="admin/welfare"> <span class="input-group-btn active-hook"> <button type="button" class="btn btn-sm btn-default search_member_payment_manual">Search
											</button> </span></div>
                            </div>
                            </div>
                        </div>
            ...
            <div class="modal-content" >
                ...
                <div class="modal-body" style="margin-top: -30px;">
                    <div class="row ">
                        ...
                        @include('includes.relatedtags',['val'=>['admin/welfare',0,'get_welfare_payment_details',3]])
    ...
    @include('includes.paymentmodal',['title'=>'Welfare'])
@endsection
