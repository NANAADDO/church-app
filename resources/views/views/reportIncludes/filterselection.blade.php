...
-->
    ...
    {!! HtmlEntities::get_dynamic_form_complete_select_c3_collective(['fetch_type', 'false','19' ,"form-control","",['1'=>'None paid month','2'=>'paid month','3'=>'group by year'],$errors,$read,' Filter By?',null])!!}
