...
Route::resource('admin/dailycollectionreport', 'Admin\\DailycollectionreportController');
...
Route::resource('admin/generalsmartmessages', 'Admin\\GeneralSmartMessagesController');
Route::post('getsmscontactfilterlist', 'Admin\\GeneralSmartMessagesController@getSMSContactFilterList');
Route::post('processsmscontactfilterlist', 'Admin\\GeneralSmartMessagesController@processSMSContactFilterList');
